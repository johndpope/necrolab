<script>
    import PowerRankingStatsChart from './PowerRankingStatsChart.vue';

    const CharacterRankingStatsChart = {
        name: 'character-ranking-stats-chart',
        extends: PowerRankingStatsChart,
        props: {
            character: {
                type: Object,
                default: () => {}
    ...
    export default CharacterRankingStatsChart;
</script>