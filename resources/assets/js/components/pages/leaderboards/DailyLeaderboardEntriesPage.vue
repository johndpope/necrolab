...
export default {
    ...
    methods: {
        loadState(route_params) {
            ...
            this.dataset = new Dataset('daily_leaderboard_entries', '/api/1/leaderboards/daily/entries');

            this.dataset.setRequestParameter('leaderboard_source', this.leaderboard_source.name);
            this.dataset.setRequestParameter('character', this.character.name);
            this.dataset.setRequestParameter('release', this.release.name);
            this.dataset.setRequestParameter('mode', this.mode.name);
            this.dataset.setRequestParameter('multiplayer_type', this.multiplayer_type.name);
            this.dataset.setRequestParameter('soundtrack', this.soundtrack.name);
