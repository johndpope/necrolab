...
use App\Jobs\Replays\Vacuum as VacuumJob;
...
class Vacuum extends Command {
     ...
     * @var string
     */
    protected $signature = 'replays:vacuum {--leaderboard_source=}';
     ...
     * @var string
     */
    protected $description = "Vacuums the replays table for each leaderboard source schema.";
