...
use App\Jobs\Leaderboards\Vacuum as VacuumJob;
...
class Vacuum extends Command {
     ...
     * @var string
     */
    protected $signature = 'leaderboards:vacuum {--leaderboard_source=}';
     ...
     * @var string
     */
    protected $description = "Vacuums the leaderboards table for each leaderboard source schema.";
