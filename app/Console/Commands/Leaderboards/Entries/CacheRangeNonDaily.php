...
class CacheRangeNonDaily extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'leaderboards:entries:non_daily:cache_range {start_date} {end_date}';
     ...
     * @var string
     */
    protected $description = "Loads non daily leaderboard entries into cache for the specified start_date and end_date.";
    ...
    public function handle() {
        ...
        $callback_handler->setCallback(function(DateTime $date) {
            CacheNonDailyJob::dispatch($date)->onConnection('sync');
        });
